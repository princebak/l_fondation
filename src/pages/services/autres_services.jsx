    ...
    <main>
      ...
      <div style={{ backgroundColor: '#fff', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className='subService'>
          ...
          <div>
            ...
            <div>
              <Accordion
                description={
                  'Notre service de paye fournit des solutions pour les problèmes administratifs et financiers auxquel petits et grands employeurs font face au moment de payer des salaires à leurs employés'
                }
              >
                <ul>
                  <li>
                    ...
                    moindre en éliminant la paperasse et améliorant la sécurité, tout en offrant aux employés un
                    meilleur service et la valeur pour leur travail acharné.
                  </li>
                  <li>
                    <p>Avantages</p>
                    Pour l’employeur:
                  ...
                  <li>
                    Le Service de la paie est un service ou une fonction supplémentaire et disponible en option sur
                    notre compte d’entreprise.
                  </li>
        ...
        <div className='rotate' style={{ display: 'flex', justifyContent: 'center', padding: '20px' }}>
          <img src='/images/services/s3.png' width='50%' height='50%' alt='autres_services' />
        </div>
      </div>
      <Footer />
    </main>
