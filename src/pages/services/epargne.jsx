        ...
        <div className='subService'>
          <div>
            ...
            <div>
              <Accordion
                description={
                  'Un compte rentable et flexible qui permet l’utilisateur d’accumuler des économies grâce à l’accumulation d’intérêts et un accès facile à ses fonds.'
                }
              >
                <ul>
                  ...
                  <li>
                    ...
                    faire croître votre épargne Ce compte vous offre un accès illimité à votre argent à travers toutes
                    nos Agences et tout agent en République démocratique du Congo
                  </li>
                </ul>
              </Accordion>
            </div>
          ...
          <div>
            ...
            <div>
              <Accordion
                description={
                  'Le Compte Libota Avenir” est conçu pour répondre aux besoins bancaires des enfants de 0 à 24 ans.Apprenez à vos enfants comment gérer l’argent à partir d’un bas âge c’est très capital'
                }
              >
                <ul>
                  <li>
                  ...
                  <li>
                    Visitez n’ importe quelle Agence à travers le pays et vous serez guidé à travers un service simple
                    et rapide
                  </li>
                  <li>
          ...
          <div>
            ...
            <div>
              <Accordion
                description={
                  'Le compte Bloqué facilite vos opérations épargne quotidiennes avec beaucoup de simplicité'
                }
              >
                <ul>
                  <li>Le compte Bloqué facilite vos opérations épargne quotidiennes avec beaucoup de simplicité</li>
                  <li>
                    Retraits et dépôts à toutes nos Agences et agent travers le pays Un taux de 5% d’intérêt l’année
                    vous est versé sur le compte courant
                  </li>
                </ul>
              </Accordion>
            </div>
